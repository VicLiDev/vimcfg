...
-- keymap.set("n", "<c-s-n>", "<c-w>n")
-- keymap.set("n", "<c-s-w>", "<c-w>w")
-- keymap.set("n", "<c-s-c>", "<c-w>c")
keymap.set("n", "<c-s-c>", ":q<cr>")
-- keymap.set("n", "<c-s-o>", "<c-w>o")

-- 取消高亮快捷键
keymap.set("n", "<Leader>h", ":noh<CR>")

-- 进入命令行
keymap.set("n", "<Leader>sh", ":shell<CR>")

-- buffer 快捷方式
-- bNext  badd  ball  bdelete  behave  belowright  bfirst  blast  bmodified
-- bnext  botright  bprevious
keymap.set("n", "<Leader>bn", ":bn<CR>")
keymap.set("n", "<Leader>bb", ":bp<CR>")
keymap.set("n", "<Leader>bs", ":b#<CR>")
keymap.set("n", "<Leader>bf", ":bfirst<CR>")
keymap.set("n", "<Leader>bl", ":blast<CR>")
keymap.set("n", "<Leader>bc", ":bwipe<CR>")
